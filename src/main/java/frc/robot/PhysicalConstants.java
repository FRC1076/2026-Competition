...
public class PhysicalConstants {
    ...
    public static class VisionConstants {
        ...
        public static class PhotonVision {
            ...
            public static final double kHubTagPriority = 100;
    ...
    public static class FieldConstants {
        ...
        public static final int aprilTagCount = VisionConstants.kAprilTagFieldLayout.getTags().size();
        public static final double aprilTagWidth = Units.inchesToMeters(6.5);

        // Field dimensions
        public static final double fieldLength = VisionConstants.kAprilTagFieldLayout.getFieldLength();
        public static final double fieldWidth = VisionConstants.kAprilTagFieldLayout.getFieldWidth();
        ...
        public static class LinesVertical {
            ...
            public static final double starting =
                VisionConstants.kAprilTagFieldLayout.getTagPose(26).get().getX();
            public static final double allianceZone = starting;
            public static final double hubCenter =
                VisionConstants.kAprilTagFieldLayout.getTagPose(26).get().getX() + Hub.width / 2.0;
            ...
            public static final double oppHubCenter =
                VisionConstants.kAprilTagFieldLayout.getTagPose(4).get().getX() + Hub.width / 2.0;
            public static final double oppAllianceZone =
                VisionConstants.kAprilTagFieldLayout.getTagPose(10).get().getX();
        }
        ...
        public static class Hub {
            ...
            public static final Translation3d topCenterPoint =
                new Translation3d(
                    VisionConstants.kAprilTagFieldLayout.getTagPose(26).get().getX() + width / 2.0,
                    fieldWidth / 2.0,
                    height);
            ...
            public static final Translation3d oppTopCenterPoint =
                new Translation3d(
                    VisionConstants.kAprilTagFieldLayout.getTagPose(4).get().getX() + width / 2.0,
                    fieldWidth / 2.0,
                    height);
            ...
            public static final Pose2d nearFace =
                VisionConstants.kAprilTagFieldLayout.getTagPose(26).get().toPose2d();
            public static final Pose2d farFace =
                VisionConstants.kAprilTagFieldLayout.getTagPose(20).get().toPose2d();
            public static final Pose2d rightFace =
                VisionConstants.kAprilTagFieldLayout.getTagPose(18).get().toPose2d();
            public static final Pose2d leftFace =
                VisionConstants.kAprilTagFieldLayout.getTagPose(21).get().toPose2d();
        }
        ...
        public static class Tower {
            ...
            public static final Translation2d centerPoint =
                new Translation2d(
                    frontFaceX, VisionConstants.kAprilTagFieldLayout.getTagPose(31).get().getY());
            public static final Translation2d leftUpright =
                new Translation2d(
                    frontFaceX,
                    (VisionConstants.kAprilTagFieldLayout.getTagPose(31).get().getY())
                        + innerOpeningWidth / 2
            ...
            public static final Translation2d oppCenterPoint =
                new Translation2d(
                    ...
                    VisionConstants.kAprilTagFieldLayout.getTagPose(15).get().getY());
        ...
        public static class Outpost {
            ...
            // Relevant reference points on alliance side
            public static final Translation2d centerPoint =
                new Translation2d(0, VisionConstants.kAprilTagFieldLayout.getTagPose(29).get().getY());
        }
    }
}
