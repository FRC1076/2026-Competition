...
public class SpindexerConstants {
    ...
    public static final double kP = 12; // TODO: tune this value
    public static final double kI = 0;
    public static final double kD = 0;
    public static final double kS = 0;
    public static final double kV = 0.057; // TODO: find this value
    public static final double kA = 0;

    public static final double kVelocityFilterTimeConstant = 0.08;
}
