...
public class FlywheelIOSingleKraken implements FlywheelIO {
    ...
    public FlywheelIOSingleKraken() {
        // Instantiate motor here
        m_motor = new TalonFX(FlywheelConstants.kLeadMotorCANId, FlywheelConstants.kCANBus);
    ...
    public void updateInputs(FlywheelIOInputs inputs) {
        ...
        inputs.appliedLeadVoltage = m_voltageSignal.getValueAsDouble();
        inputs.velocityRadiansPerSecond = m_unitConverter.toSIVel(m_velocitySignal.getValueAsDouble());
        inputs.leadCurrentAmps = m_currentSignal.getValueAsDouble();
        inputs.leadTemperatureDegC = m_temperatureSignal.getValueAsDouble();
