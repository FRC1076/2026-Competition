...
public class FlywheelConstants {
    ...
    public static final double kSetpointToleranceRadPerSec = 35;
    public static final double kSumCurrentForShootingAmps = 80;
    public static final double kMaxShootingDelaySecs = 0.5;
