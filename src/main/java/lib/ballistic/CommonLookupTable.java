...
public class CommonLookupTable {
    ...
    static {
        ...
        hubTable.hoodAngle.put(5.0, 0.16);
        ...
        hubTable.flywheelSpeed.put(1.0, 195.0);
        hubTable.flywheelSpeed.put(2.0, 210.0);
        hubTable.flywheelSpeed.put(2.5, 217.5);
        hubTable.flywheelSpeed.put(3.0, 235.0);
        hubTable.flywheelSpeed.put(4.0, 255.0);
        hubTable.flywheelSpeed.put(5.0, 280.0);
        hubTable.flywheelSpeed.put(6.0, 305.0);
        hubTable.flywheelSpeed.put(8.0, 355.0); // Extrapolated by Gemini
        hubTable.flywheelSpeed.put(10.0, 440.0); // Extrapolated by Gemini
        hubTable.flywheelSpeed.put(12.0, 480.0); // Extrapolated by Gemini
