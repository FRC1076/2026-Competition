 ...
 */
public class DynamicProfiledPIDController implements Sendable {
    private static int instances;

    private DynamicPIDController m_controller;
    ...
    /**
     * Allocates a ProfiledPIDController with the given constants for Kp, Ki, and Kd and a default period of 0.02 seconds
     *
     ...
     */
    public DynamicProfiledPIDController(
        double Kp, double Ki, double Kd, TrapezoidProfile.Constraints constraints) {
        this(Kp, Ki, Kd, () -> 0.02, 0.02, 0.02, constraints);
    }
     ...
     * @param Kd The derivative coefficient.
     * @param constraints Velocity and acceleration constraints for goal.
     * @param periodSupplier Supplies the period between controller updates in seconds. 
     * @throws IllegalArgumentException if kp &lt; 0
     * @throws IllegalArgumentException if ki &lt; 0
     * @throws IllegalArgumentException if kd &lt; 0
     * @throws IllegalArgumentException if minPeriod &gt; maxPeriod
     * @throws IllegalArgumentException if minPeriod &lt;= 0
     * @throws IllegalArgumentException if maxPeriod &lt;= 0
     * @throws IllegalArgumentException if periodSupplier == null
     */
    @SuppressWarnings("this-escape")
    public DynamicProfiledPIDController(
        double Kp, double Ki, double Kd, DoubleSupplier periodSupplier, double minPeriod, double maxPeriod, TrapezoidProfile.Constraints constraints) {
        m_controller = new DynamicPIDController(Kp, Ki, Kd, periodSupplier, minPeriod, maxPeriod);
